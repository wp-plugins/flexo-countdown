...
<script type='text/javascript'>
	...
	public static function fb_menu () {
			add_options_page('flexoCounter settings','flexoCounter settings','manage_options','flexoCounter-settings','flexoCounter::display_options','');
...
if(function_exists('add_action')):
	add_action('admin_menu', 'flexoCounter::fb_menu');
	
	add_filter('the_content', 'flexoCounter::the_content', 1);

	add_action('init','flexoCounter::init');
	add_action('wp_footer', 'flexoCounter::wp_footer');
endif;
?>